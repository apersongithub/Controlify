...
public class KeyboardWidget extends AbstractWidget implements ContainerEventHandler, ComponentProcessor {
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        for (KeyWidget key : keys) {
            ...
            // extract method of keys are empty - this doesn't actually do any rendering
            key.extractRenderState(guiGraphics, mouseX, mouseY, partialTick);
        }
        ...
        Blit.batchDraw(guiGraphics, () -> {
            ...
            guiGraphics./*? if >=1.21.9 && <1.21.11 {*//*submitOutline*//*?} else {*/outline/*?}*/(getX(), getY(), getWidth(), getHeight(), 0xFFAAAAAA);
