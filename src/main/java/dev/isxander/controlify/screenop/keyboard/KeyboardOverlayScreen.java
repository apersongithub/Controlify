...
public class KeyboardOverlayScreen extends Screen {
    ...
    *///?}
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        this.backgroundScreen.extractRenderState(guiGraphics, mouseX, mouseY, partialTick);
    ...
    public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        // above render(..) call called extractBackground pre 1.21.6 which renders background twice
        //? if >=1.21.6
        this.backgroundScreen.extractBackground(guiGraphics, mouseX, mouseY, partialTick);
    }
